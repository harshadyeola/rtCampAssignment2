...
wordpress_install () {
	...
	mysql -u root -p$DB_ROOT -e "create database $DOMAIN_NAME$DB_XT; GRANT ALL PRIVILEGES ON $DOMAIN_NAME$DB_XT.* TO admin@localhost IDENTIFIED BY 'password'" >> $LOG 2>&1
